...
import cn.lwydyby.openapi.scanner.consts.CommonConsts;
import cn.lwydyby.openapi.scanner.consts.ProtocolTypes;
...
import static cn.lwydyby.openapi.scanner.consts.CommonConsts.PACKAGE_SEPARATOR;
import static cn.lwydyby.openapi.scanner.consts.CommonConsts.PATH_SEPARATOR;
...
public enum ScannerUtil {
    ...
    static class UrlScanCallable implements Callable<List<Class>> {
        private static Logger log= LoggerFactory.getLogger(UrlScanCallable.class);
        /**
         * 需匹配的包名
         */
        private String pkg;
